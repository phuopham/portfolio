export const TESTIMONIAL_POSITION = ["pos0", "pos1", "pos2", "pos3", "pos4", "pos5"];

export const TESTIMONIAL_PROPERTYVARIANTS = {
...
export const TESTIMONIAL_DATA = [
    {
        ...
        testimonial: 'Usually we pay in 15 days, but just for your good support, we cleared it today. Thank you and i\'m looking for our next colaboration.',
    },
    {
        index: 1,
