...
export const Badges = ({ children, baseVelocity = 100 }: { children: ReactNode, baseVelocity: number }) => {
    ...
    return (
        <section className="text-center">
            <SectionTitle>My badge collection</SectionTitle>
            <div className="overflow-hidden w-[95vw]">
                <motion.div className=" flex gap-24 items-center" style={{ x }}>
                    {children}
                    {children}
                    {children}
                    {children}
