...
export const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hi there</span>, I'm <span className="font-bold text-purple-500">Phuong Pham</span>, a <span className="font-bold"> full-stack developer</span> and an<span className="font-bold"> IT engineer</span> from <span className="font-bold"> Vietnam.</span>
      </motion.h1>
