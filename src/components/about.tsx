...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <h2 className="m-auto py-3 px-12 rounded-full inline-block text-3xl font-medium text-purple-700 dark:mix-blend-difference bg-slate-100/10 mb-8 text-center">About me</h2>
